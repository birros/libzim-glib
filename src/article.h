...
const char   zim_article_get_namespace (ZimArticle *article);
const char * zim_article_get_data (ZimArticle *article, gsize *size);
gsize        zim_article_get_data_size (ZimArticle *article);
gsize        zim_article_get_offset (ZimArticle *article);
